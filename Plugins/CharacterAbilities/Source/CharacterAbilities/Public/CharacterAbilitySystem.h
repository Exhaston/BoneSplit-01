...
DECLARE_MULTICAST_DELEGATE_FiveParams(FOnDamageEvent, 
...
DECLARE_MULTICAST_DELEGATE_FiveParams(FOnHealEvent, 
	UAbilitySystemComponent* SourceAsc,
	UAbilitySystemComponent* TargetAsc, 
	FGameplayTagContainer EffectTags, 
	float BaseHeal, 
...
class CHARACTERABILITIES_API UCharacterAbilitySystem : public UAbilitySystemComponent
{
	GENERATED_BODY()
