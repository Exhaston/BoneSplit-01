...
#include "AbilityTask_PlayMontageWaitForEvent.generated.h"
 ...
 * 
 */
UCLASS(DisplayName="Play Montage And Wait For Event")
class CHARACTERABILITIES_API UAbilityTask_PlayMontageWaitForEvent : public UAbilityTask
{                               
	GENERATED_BODY()
	
	public:
	// Constructor and overrides
	UAbilityTask_PlayMontageWaitForEvent(const FObjectInitializer& ObjectInitializer);
	...
	*/
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Ability|Tasks", meta = (HidePin = "OwningAbility", DefaultToSelf = "OwningAbility", BlueprintInternalUseOnly = "TRUE", AdvancedDisplay="TaskInstanceName, Rate, StartSection, bStopWhenAbilityEnds, AnimRootMotionTranslationScale"))
	static UAbilityTask_PlayMontageWaitForEvent* PlayMontageAndWaitForEvent(
			UGameplayAbility* OwningAbility,
			FName TaskInstanceName,
			UAnimMontage* MontageToPlay,
			FGameplayTagContainer EventTags,
			FGameplayAttribute SpeedModifierAttribute,
			float Rate = 1.f,
