...
//
// Intended to be used together with UClientAuthoritativeCharacterMovementComponent & AClientAuthoritativePlayerController
UCLASS()
class CLIENTAUTHORITATIVECHARACTERSYSTEM_API AClientAuthoritativeCharacter : public ACharacter
{
	GENERATED_BODY()
...
public:
	...
	void PostNetReceiveBasedMovement(const FClientAuthoritativeMoveData& MoveData);
