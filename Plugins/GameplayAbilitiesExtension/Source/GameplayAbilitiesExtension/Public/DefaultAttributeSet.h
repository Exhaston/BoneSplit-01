...
{
	GAMEPLAYABILITIESEXTENSION_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(SetByCaller_Shield);
	GAMEPLAYABILITIESEXTENSION_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(SetByCaller_CurrentHealth);
	GAMEPLAYABILITIESEXTENSION_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(SetByCaller_MaxHealth);
	GAMEPLAYABILITIESEXTENSION_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(SetByCaller_Damage);
	GAMEPLAYABILITIESEXTENSION_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(SetByCaller_Healing);
	GAMEPLAYABILITIESEXTENSION_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(SetByCaller_Duration);
}
...
class GAMEPLAYABILITIESEXTENSION_API UDefaultAttributeSet : public UAttributeSet
{
	GENERATED_BODY()
