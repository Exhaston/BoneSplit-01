...
public:
	...
	virtual void ApplyDefaultEquipment();
	...
	FBSOnEquipmentDelegate& GetOnEquipmentAppliedDelegate() { return OnEquipmentApplied; }
	FBSOnEquipmentDelegate& GetOnEquipmentRemovedDelegate() { return OnEquipmentRemoved; }
